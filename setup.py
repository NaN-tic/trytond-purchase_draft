#!/usr/bin/env python
# This file is part purchase_draft module for Tryton.
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-purchase_draft',
    download_url='https://github.com:nantic/trytond-purchase_draft.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-purchase_draft.git'
    },
    classifiers=[
